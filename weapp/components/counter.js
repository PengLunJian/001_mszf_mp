...
_core["default"].component({
  ...
  computed: (0, _redux.mapState)(['counter']),
  events: {
  ...
  methods: _objectSpread({}, (0, _redux.mapActions)({
    increment: _types.INCREMENT,
    decrement: _types.DECREMENT,
...
}, {info: {"components":{},"on":{}}, handlers: {'59-0': {"tap": function proxy () {

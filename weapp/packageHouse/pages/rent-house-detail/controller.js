...
var STATES = {
  isLoading: function isLoading(state) {
    return state.HOUSEDETAIL_REDUCER.isLoading;
  },
  isSuccess: function isSuccess(state) {
    return state.HOUSEDETAIL_REDUCER.isSuccess;
  },
  isFailure: function isFailure(state) {
    return state.HOUSEDETAIL_REDUCER.isFailure;
  },
  isData: function isData(state) {
    return state.HOUSEDETAIL_REDUCER.data;
  }
};

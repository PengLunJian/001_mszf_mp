...
var STATES = {
  isLoading: function isLoading(state) {
    return state.HOUSELIST_REDUCER.isLoading;
  },
  isSuccess: function isSuccess(state) {
    return state.HOUSELIST_REDUCER.isSuccess;
  },
  isFailure: function isFailure(state) {
    return state.HOUSELIST_REDUCER.isFailure;
  },
  isData: function isData(state) {
    return state.HOUSELIST_REDUCER.data;
  }
};
exports.STATES = STATES;
var ACTIONS = {
  resetHouseList: actionTypes.RESET_HOUSELIST_STATE,
  ajaxHouseList: function ajaxHouseList(params) {
    return actions.ajaxRequestHouseList(params);
  }
};

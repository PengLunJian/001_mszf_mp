...
exports.ajaxRequestHotHouse = exports.ajaxRequestHouseHistory = exports.ajaxRequestHouseFavorite = exports.ajaxRequestHouseUnfollow = exports.ajaxRequestHouseFollow = exports.ajaxRequestHouseDetail = exports.ajaxRequestHouseList = void 0;
...
var ajaxRequestHotHouseNew = function ajaxRequestHotHouseNew() {
  return _axios["default"].get(_apis["default"].selectHotHouseNew).then(function (res) {
    res = res || {};
    return res;
  });
};

var ajaxRequestHotHouseSecond = function ajaxRequestHotHouseSecond() {
  return _axios["default"].get(_apis["default"].selectHotHouseSecond).then(function (res) {
    res = res || {};
    return res;
  });
};

var ajaxRequestHotHouseRent = function ajaxRequestHotHouseRent() {
  return _axios["default"].get(_apis["default"].selectHotHouseRent).then(function (res) {
    res = res || {};
    return res;
  });
};
